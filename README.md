...
| MIDI | [midisaya](https://github.com/wachin/midisaya) | This is a backup of midisaya.com, a site of MIDI sequences of Christian Praise that was active some years ago. Edgar A. Franco released all the MIDI files <br/> <br/> Este es un respaldo de midisaya.com, un sitio de secuencias MIDI de Alabanzas Cristianas que estuvo activo hace algunos años atrás. Edgar A. Franco liberó todos los archivos MIDI |
| Python | [DrumBurp](https://github.com/wachin/DrumBurp) | Resurrecting DrumBurp, the best free simple drum tab editor, designed to make it quick and easy to enter drum tabs <br/> <br/> Resucitando DrumBurp, el mejor editor de tablaturas de batería gratuito y simple, diseñado para que sea rápido y fácil ingresar tablaturas de batería |
| Python, PyQt6 | [mp3-cover-art-manager](https://github.com/wachin/mp3-cover-art-manager) | Cover Finder is a graphical application that helps you search for and add album art (cover art) to your MP3 files. It uses iTunes and Deezer APIs to automatically find the best matching covers for your songs <br/> <br/> Cover Finder es una aplicación gráfica que te ayuda a buscar y agregar portadas de álbum a tus archivos MP3. Usa las APIs de iTunes y Deezer para encontrar automáticamente las mejores portadas para tus canciones |
| Python, PyQt6 | [lingot](https://github.com/wachin/lingot) | Port to PyQt6 of Lingot Musical instrument tuner <br/> <br/> Puerto a PyQt6 de Lingot, afinador de instrumentos musicales |
| Python, PyQt6 | [txt-to-chordpro-converter](https://github.com/wachin/txt-to-chordpro-converter) | Multi-file PyQt6 GUI converter for transforming church TXT chord sheets into valid ChordPro format <br/> <br/> Convertidor GUI multi-archivo PyQt6 para transformar hojas de acordes TXT de iglesias en formato ChordPro válido |
| Python, PyQt6 | [puddletag](https://github.com/wachin/puddletag) | Renewed maintenance work of puddletag, the Powerful, simple, audio tag editor for GNU/Linux <br/> <br/> Trabajo de mantenimiento renovado de puddletag, el editor de etiquetas de audio poderoso y simple para GNU/Linux |
| Python, PyQt6 | [Song-Lyrics-formatter-for-Holyrics](https://github.com/wachin/Song-Lyrics-formatter-for-Holyrics) | Praise song lyrics formatter for projecting with Holyrics <br/> <br/> Formateador de letras de alabanzas para proyectar con Holyrics |
| Kotlin, Android | [ChordStudioApp](https://github.com/wachin/ChordStudioApp) | ChordStudioApp is an Android app for opening plain text chord sheets and transposing the chords by semitones while keeping the song text readable <br/> <br/> ChordStudioApp es una aplicación Android para abrir hojas de acordes en texto plano y transponer los acordes por semitonos manteniendo el texto de la canción legible |
...
| Document | [Dietary-Guidelines-for-Americans-2025-2030](https://github.com/wachin/Dietary-Guidelines-for-Americans-2025-2030) | Dietary Guidelines for Americans 2025-2030 <br/> <br/> Guías Alimentarias para Estadounidenses 2025-2030 |
